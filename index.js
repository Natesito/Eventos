let cambiodom = document.getElementById("texto");
cambiodom.innerHTML = "Apreta el boton para registrarte"

let estiloButton = document.getElementById('button');
estiloButton.style.border = 'solid';
estiloButton.style.textTransform = 'uppercase';
